    ...
    emailjs
      .send(
        ...
        import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
        {
          ...
          to_email: "ardalanmemar@gmail.com",
      ...
      <motion.div variants={slideIn('left', "tween", 0.2, 1)} className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
          <label className="flex flex-col">
            <span className="text-whit font-medium mb-4">Your Name</span>
          ...
          <label className="flex flex-col">
            <span className="text-whit font-medium mb-4">Your Email</span>
          ...
          <label className="flex flex-col">
            <span className="text-whit font-medium mb-4">Your Message</span>
